...
**Step 2: Виконати критичний аудит ВСІХ файлів проєкту**

**ОБОВ'ЯЗКОВО перед створенням релізу!**

```bash
# Використати /find-bugs skill для повного аналізу ВСІХ файлів:
# - ВСІ source файли проєкту (35+ файлів)
# - Створити AUDIT_REPORT_v0.5.0.md
# - Перевірити:
...
**Step 4: Виконати критичний аудит ВСІХ файлів проєкту**

**ОБОВ'ЯЗКОВО після push, але ПЕРЕД tag і release!**

```bash
# Використати /find-bugs skill для аналізу ВСІХ файлів проєкту:
# - ВСІ 35+ source файли (не тільки нові)
# - Нові файли v0.6.0: run.py, CI/CD workflows, USER_GUIDE.md
# - Перевірити: безпека, якість коду, продуктивність
# - Створити AUDIT_REPORT_v0.6.0.md
```
...
Показати AUDIT_REPORT_v0.6.0.md користувачу та отримати явне підтвердження на реліз.
